"""Tests that libras3d is functional for i.hyper.geology standalone mode."""
import os, sys
import numpy as np
import pytest
...
def test_wavelength_sidecar():
    ...
    ras3d.close_cube(h)
    sys.path.insert(0, '/home/yann/dev/i.hyper.geology')
    import importlib
    m = importlib.import_module('i_hyper_geology')
    try:
